...
`git clone https://github.com/spring-guides/gs-consuming-rest-xml-android.git`
...
[zip]: https://github.com/spring-guides/gs-consuming-rest-xml-android/archive/master.zip
